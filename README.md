...
1. Cada fila representa un *trabajo* de importación, añade tantas como necesites.
    ...
    + **Opciones de copia**: Estas casillas de verificación permiten escoger selectivamente qué elementos del rango de origen, además del propio contenido de las celdas, serán copiados. Solo aparecerán en la fila correspondiente cuando la columna **ID / URL** deje de estar vacía.
